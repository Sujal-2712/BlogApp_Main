...
const BlogEditor = () => {
    ...
    const handleBannerUpload = async (e) => {
        ...
        if (img) {
            ...
            try {
                // Log to debug the image file being uploaded
                ...
                const response = await fetch(`${API_URL}/upload`, {
                    ...
                    body: formData,
                    headers: {
                        Authorization: `Bearer ${access_token}`, // Add token if required
                    },
                });
                ...
                if (response.ok && data.success) {
                    setBlog({ ...blog, banner: data.imageUrl }); // Set uploaded image URL
